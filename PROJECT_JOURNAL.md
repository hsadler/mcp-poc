...
5. Added development tooling: MCP Inspector integration for interactive tool testing via web UI at localhost:6274, and a Makefile with a `make dev` command that launches the inspector with the MCP server.
